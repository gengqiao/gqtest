...
public class ExportClass {
	...
	public static void main(String[] args) {
		...
		String key = "org.owasp.csrfguard.protected.saveUser";
		if (key.startsWith("org.owasp.csrfguard.protected.")) {
	        String directive = key.substring("org.owasp.csrfguard.protected.".length());
	        int index = directive.indexOf(46);
	        System.out.println(directive+"===="+index);
		}
	        
		ExportClass exportClass = new ExportClass();
		//exportClass.exportAll("F:\\svn_update\\", "F:\\workspaceRoom\\jngl_mysql", true);// 提取在svn提取目录下，除WebRoot
		//exportClass.exportAll("F:\\svn_update\\", "F:\\workspaceRoom\\thjngl_cms_new", true);// 提取在svn提取目录下，除WebRoot
		//exportClass.exportAll("F:\\svn_update\\", "F:\\workspaceRoom\\thjnpx_forum", true);// 提取在svn提取目录下，除WebRoot
		
		exportClass.exportAll("E:\\svn_update\\", "E:\\soft\\workspace_demo\\thbzz", true);// 提取在svn提取目录下，除WebRoot
	//	exportClass.exportAll("E:\\svn_update\\", "E:\\soft\\workspace_ggj\\jngl_mysql", true);
		
		
		//exportClass.exportAll("F:\\svn_update\\", "F:\\workspaceRoom\\zgclCMS", true);// 提取在svn提取目录下，除WebRoot
		
		
		//exportClass.exportAll("F:\\svn_update\\", "F:\\workspaceRoom\\zgcl_mysql_new", true);// 提取在svn提取目录下，除WebRoot
		
		//exportClass.exportAll("F:\\svn_update\\main", "F:\\workspaceRoom\\zgclmysql", true);// 提取在svn提取目录下，除WebRoot
		//exportClass.exportAll("F:\\svn_update", "E:\\STS\\sns_multimanage", true);// 提取在svn提取目录下，除WebRoot
